    ...
    nav {
      language {
        override {
          ...
          # cat=introduction plus - language menu/100/100; type=string; label=Icon Menu:List of menu with icons devided by a double pipe. Needed if you are using the language icons menu. Not needed in case of the language text menu. I.e: English || Deutsch || Francoise
